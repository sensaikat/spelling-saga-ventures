...
const OptionButton: React.FC<OptionButtonProps> = ({ option, languageId, onSelect }) => {
  ...
  return (
    <motion.button
      className="bg-white border border-gray-200 rounded-lg p-4 text-center hover:border-game-blue hover:shadow-md transition-all flex items-center justify-between min-h-[5rem]"
